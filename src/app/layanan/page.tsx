...
export const metadata: Metadata = {
  ...
  description: 'Layanan kreatif dan digital dari Aria Labs, Web Development, Brand Identity, UI/UX Design, Graphic Design, Social Media Management, dan Photo & Video.',
}
